    ...
    <Formik
      ...
      onSubmit={async (values) => {
        ...
        if (fetchAsyncResetPassword.fulfilled.match(registrationResult)) {
          ...
          toast.success('パスワードのリセットが完了しました！');
          navigate("/auth/login")
        }else{
          dispatch(fetchCredEnd());
