    ...
    >
        ...
        <div className="auth_page">
            ...
            <div className="auth_form__right">
                ...
                {/* Success Message */}
                {!openMessage ?
                    <div className="auth_text">パスワードを再設定します。登録しているメールアドレスを入力して下さい。</div>
                    :
                    <div className="auth_message">メールを確認して下さい。</div>
                }
