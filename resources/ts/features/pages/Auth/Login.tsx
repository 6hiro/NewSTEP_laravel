    ...
    const LoginSubmit = (email: string, password: string) => {
      ...
      axios.get('/sanctum/csrf-cookie').then(response => {
        axios.post(`/api/login`, data).then(res => {
          dispatch(setUser({id:res.data.user.id, name:res.data.user.name, nick_name:res.data.user.nick_name}));
         ...
         .catch(function (e) {
          if(e.response.status===401){
            ...
            toast.error('メールアドレスの検証が完了していません');
          }else{
              ...
              <form onSubmit={handleSubmit} className="auth_form">
                ...
                <div className="auth_form__right">
                  ...
                  {touched.email && errors.email ? (
                    <div className="auth_error"><i className='bx bx-info-circle'></i>{errors.email}</div>
                  ) : null}
                  ...
                  {touched.password && errors.password ? (
                    <div className="auth_error"><i className='bx bx-info-circle'></i>{errors.password}</div>
                  ) : null}
